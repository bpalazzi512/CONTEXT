...
create table if not exists sliders (
    ...
    leisure int,
    cost_of_life int,
    avg_temp_selected boolean,
    rail_density_selected boolean,
    education_selected boolean,
    crime_safety_selected boolean,
    pop_density_selected boolean,
    healthcare_selected boolean,
    leisure_selected boolean,
    cost_of_life_selected boolean,
    userID int unique not null,
    check (avg_temp between 0 and 100),
