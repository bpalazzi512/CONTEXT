...
(1, 'United States', 9833520, 331002651, 7.2, 293564, 5.8, 'bio', 'tips'),
(2, 'Canada', 9984670, 37742154, 7.6, 48922, 6.5, 'bio', 'tips'),
(3, 'Mexico', 1964375, 128932753, 6.5, 26366, 4.7, 'bio', 'tips'),
(4, 'Brazil', 8515767, 212559417, 6.3, 30624, 13.2, 'bio', 'tips'),
(5, 'United Kingdom', 243610, 67886011, 7.8, 16632, 4.5, 'bio', 'tips');
